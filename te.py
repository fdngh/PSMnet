    ...
    with torch.no_grad():
        ...
        for curr_lb in test_labels:
            ...
            for sample_batched in testloader:
                ...
                query_pred, _,im,q = model( sup_img_part , sup_fgm_part, sup_bgm_part, query_images,tra_wsize=None, isval = True, val_wsize = _config["val_wsize"] )
                ...
                cv2.imwrite('1', superimposed_img)
